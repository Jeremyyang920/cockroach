...
func NewProcessor(
	...
	if core.Replication != nil {
		...
		return NewReplicationProcessor(ctx, flowCtx, processorID, *core.Replication)
	}
...
var NewReplicationProcessor func(context.Context, *execinfra.FlowCtx, int32, execinfrapb.ReplicationSpec) (execinfra.Processor, error)
